        ...
        <div class="container dashboard__container">
            ...
            <aside>
                <ul>
                    ...
                    <li><a href="{{ route('admin_manage_category') }}" class="active"><i class="uil uil-list-ul"></i>
                ...
                <table id="usertable">
                    ...
                    <tbody>
                        @foreach ($data as $c)
                            <tr>
                                <td>{{ $c->title }}</td>
                                <td><a href="{{ route('admin_edit_category', ['id' => $c->id]) }}"
                                        class="btn sm">Edit</a></td>
                                <td><a href="{{ route('admin_deletecategory', ['id' => $c->id]) }}"
