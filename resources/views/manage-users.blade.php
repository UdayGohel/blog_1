...
<body>
    ...
    <section class="dashboard">
        <div class="container dashboard__container">
            ...
            <aside>
                <ul>
                    <li><a href=""><i class="uil uil-pen"></i>
                            <h5>Add Post</h5>
                        </a>
                    </li>
                    <li><a href=""><i class="uil uil-postcard"></i>
                            <h5>Manage Posts</h5>
                        </a>
                    </li>
                    ...
                    <li><a href="{{ route('admin_manageUser') }}" class="active"><i class="uil uil-users-alt"></i>
                            <h5>Manage User</h5>
                        </a>
                    </li>
                    ...
                    <tbody>
                        @foreach ($data as $u)
                            <tr>
                                <td>{{ $u->firstname }}</td>
                                <td>{{ $u->username }}</td>
                                <td><a href="{{ route('admin_editUser', ['id' => $u->user_id]) }}"
                                        class="btn sm">Edit</a>
                                </td>
                                <td><a href="{{ route('admin_deleteUser', ['id' => $u->user_id]) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.dataTables_wrapper').css("margin-top", "1em");
        });
    </script>
